...
export async function verifyAuthentication(authenticationRaw, credential, expected, crypto) {
...
async function parseCryptoKey(algoParams, publicKey, crypto) {
...
export async function verifySignature({ algorithm, publicKey, authenticatorData, clientData, signature, verbose, crypto }) {
