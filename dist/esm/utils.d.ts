...
export declare function parseBase64UrlLegacy(txt: string): ArrayBuffer;
export declare function toBase64urlLegacy(buffer: ArrayBuffer): string;
export declare function sha256(buffer: ArrayBuffer, externalCrypto?: Crypto): Promise<ArrayBuffer>;
